...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2024 04:35:57 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{asset('storage/assets/css/vendor/flaticon/flaticon.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('storage/assets/css/vendor/jquery-ui.min.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('storage/assets/css/vendor/base.css')}}">
...
============================================ -->
    <!-- Modernizer JS -->
    <script src="{{asset('storage/assets/js/vendor/modernizr.min.js')}}"></script>
    <!-- jQuery JS -->
    <script src="{{asset('storage/assets/js/vendor/jquery.js')}}"></script>
    <!-- Bootstrap JS -->
    <script src="{{asset('storage/assets/js/vendor/popper.min.js')}}"></script>
    ...
    <script src="{{asset('storage/assets/js/vendor/jquery-ui.min.js')}}"></script>
    <script src="{{asset('storage/assets/js/vendor/jquery.ui.touch-punch.min.js')}}"></script>
    ...
    <script src="{{asset('storage/assets/js/vendor/counterup.js')}}"></script>
    <script src="{{asset('storage/assets/js/vendor/waypoints.min.js')}}"></script>
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2024 04:36:39 GMT -->
</html>